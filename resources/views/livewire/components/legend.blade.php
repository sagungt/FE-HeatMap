<!-- Legend Information -->
<div x-data="dataOrdinal" class="relative bottom-[310px] left-[50%] -translate-x-[50%] sm:w-[350px] h-[310px] sm:h-[250px] sm:bottom-[240px] sm:left-48 z-[9999] w-[90%] lg:w-[310px] lg:left-44 lg:bottom-[400px] lg:h-[400px]">
        ...
        <div class="flex flex-col gap-2 mx-5 lg:mx-0">
            <template x-for="value in ordinal">
                <div x-on:click="showHeatmap(value.index)" class="flex items-center gap-4 transition delay-700 cursor-pointer">
                    ...
                    <p class="text-xs lg:text-sm" x-text="value.l + ' - ' + value.g "></p>
                </div>
            </template>
        </div>
