<!-- Legend Information -->
<div x-data="dataOrdinal" class="legend absolute bottom-10 left-5 z-[9999] w-[230px] h-[470px] sm:w-[380px] sm:h-[160px] md:w-[350px] md:h-[160px] lg:w-[300px] lg:h-[384px] duration-700">
    
    <div class="information-legend bottom-0 gap-4 flex flex-col justify-center rounded-lg duration-700 md:duration-500 bg-white absolute w-full py-4 lg:py-5 z-[999] lg:px-5 lg:gap-4 shadow-lg sm:-m-5 sm:ml-0.5">
