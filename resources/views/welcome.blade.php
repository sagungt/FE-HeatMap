...
@section('content')
    ...
    <!-- Loading indicator -->
    <div id='loading' class="absolute bottom-[65%] left-[40%] right-[60%] lg:top-5 lg:left-5 lg:right-0 hidden items-center justify-center z-[999] bg-white w-[100px] h-[50px] rounded">
    ...
    <!-- Error indicator -->
    <div id='error' class="absolute z-[999] top-20 right-5 lg:top-5 lg:left-5 lg:right-0 w-[175px] h-[40px] bg-red-600 hidden items-center justify-center rounded">
